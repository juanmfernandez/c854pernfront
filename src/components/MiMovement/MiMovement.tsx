  ...
  return (
    <div className="2xl:container 2xl:mx-auto 2xl:px-0 py-3 md:px-10">
      ...
      <div className="py-8 text-center">
        ...
        Sentite inspirado por otros amantes del deporte como vos, que han compartido su MOVE.
        </p>
      </div>
            ...
            {data.resources.map((resource, index) => {
              return (
                ...
                >
                  ...
                  <a
                    href={resource.link}
                    className="h-full w-full aspect-square block absolute top-0 left-0 transition-opacity duration-300 opacity-0 hover:opacity-100 bg-emerald-600/75 z-10"
                  >
